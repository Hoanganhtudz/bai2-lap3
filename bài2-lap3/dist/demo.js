...
var cuoi = document.getElementById('cuoi');
...
var prices = (sort_type) => {
    let _myData = myDatas();
    if (sort_type == "ascending") {
        let studenSort = data.sort(function (a, b) {
...
var input_class = document.getElementById("category");
var btn_filter = document.getElementById("btn");
